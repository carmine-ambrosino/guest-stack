function createUserElement(user) {
  ...
  updateButton.textContent = "🖊"; // Aggiungi solo la scritta "Update"

  // Bottone Delete
  const deleteButton = document.createElement("button");
  deleteButton.className = "text-lg font-bold text-red-500 hover:text-red-600"; 
  deleteButton.textContent = "❌"; // Aggiungi solo la scritta "Delete"

  buttonDiv.appendChild(updateButton);
  buttonDiv.appendChild(deleteButton);

  rightDiv.appendChild(buttonDiv); // Aggiungi i pulsanti sotto l'ora di scadenza
